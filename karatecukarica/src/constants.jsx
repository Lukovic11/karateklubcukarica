...
export const ENROLL_TEXT = (
  <>
    ...
    <p>
      Naš klub okuplja sve generacije – od najmlađih do odraslih, takmičare i
      rekreativce.
    </p>
...
export const ITEM1_TEXT =
  " Da bi dete počelo da vežba karate, kimono nije neophodan. Dovoljni su trenerka dugih nogavica i majica" +
  "            kratkih rukava.";
export const ITEM2_TITLE = "Osvežavajući napici";
export const ITEM2_TEXT =
  " Jedini napitak koji može da hidrira dete je VODA i zato nije poželjno donositi sokove i slične napitke. Potrebno je da dete ima svoju PLASTIČNU flašicu, obeleženu tako da može da je prepozna.";
export const ITEM3_TITLE = "Priprema za trening i presvlačenje";
export const ITEM3_TEXT =
  "Bez obzira koliko godina deca imaju, potrebno je da se uče samostalnosti i odgovornosti. To je jedan od zadataka i ciljeva treninga. Zato je važno dovesti dete na vreme (desetak minuta pre treninga) i pustiti ga da se samostalno presvuče.";
export const ITEM4_TITLE = "Higijena";
export const ITEM4_TEXT =
...
export const ITEM5_TITLE = "Prisustvo roditelja na treningu";
export const ITEM5_TEXT =
...
export const ITEM6_TITLE = "Komunikacija trenera i roditelja";
export const ITEM6_TEXT =
...
export const ITEM7_TITLE = "Komunikacija sa sekretarom kluba";
export const ITEM7_TEXT =
  "Sekretar kluba dostupan Vam je pre ili posle treninga u prostorijama kluba, ali će Vam rado odgovoriti i na\n" +
  "            poruke.";
export const ITEM8_TITLE = "Karate zajednica";
export const ITEM8_TEXT =
...
export const FOOTER_TXT1 = (
  <>
    <div className="footer-text">
      <p className="p-footer">Karate klub "Čukarica"</p>
      <p className="p-footer">Ul. Jablanička 3I, 11000 Beograd, Cerak</p>
    </div>
  </>
);
...
export const FOOTER_TXT2 = (
  <>
    <div className="footer-text">
      ...
      <p className="p-footer">Tel. 069 50 31 843</p>
      <p className="p-footer">Tel. 065 27 95 095</p>
    </div>
  </>
);
//Locations
...
export const CAMP_2022_DESC = "I ove godine karate klub Čukarica organizuje letnji karate kamp za sve zainteresovane članove kluba. Naša baza biće Kopaonik – hotel „Klub A“.";
