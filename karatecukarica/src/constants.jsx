...
export const ITEM2_TEXT = " Jedini napitak koji može da hidrira dete je VODA i zato nije poželjno donositi sokove i slične napitke. Potrebno je da dete ima svoju PLASTIČNU flašicu, obeleženu tako da može da je prepozna."
export const ITEM3_TITLE = "Priprema za trening i presvlačenje";
export const ITEM3_TEXT = "Bez obzira koliko godina deca imaju, potrebno je da se uče samostalnosti i odgovornosti. To je jedan od zadataka i ciljeva treninga. Zato je važno dovesti dete na vreme (desetak minuta pre treninga) i pustiti ga da se samostalno presvuče."
export const ITEM4_TITLE = "Higijena";
export const ITEM4_TEXT = "Deca se uče da održavaju ličnu higijenu, ali i da vode računa o čistoći prostora koji koriste i u kojem\n" +
...
export const ITEM5_TEXT = "Roditeljima nije dozvoljen ulazak u salu. Trening je vreme Vašeg deteta i čini deo njegove privatnosti. Osim\n" +
...
export const ITEM6_TEXT = "Molimo Vas za strpljenje. U vreme treninga, trener ne može komunicirati sa roditeljima, ali to može učiniti\n" +
  "            pre ili nakon treninga."
export const ITEM7_TITLE = "Komunikacija sa sekretarom kluba";
export const ITEM7_TEXT = "Sekretar kluba dostupan Vam je pre ili posle treninga u prostorijama kluba, ali će Vam rado odgovoriti i na\n" +
  "            poruke."
