  ...
  return <div>
    ...
    <div className="schedules-and-locations">
      ...
      <div className="location-wrapper">
        ...
        {map2 && <div className={map2 ? "map-container" : "hidden map-container"}>
          <iframe className="map"
      ...
      <div className="location-wrapper">
        ...
        {kindergarten === SCHEDULE3.loc1.name && map3 &&
        ...
        {kindergarten === SCHEDULE3.loc2.name && map3 &&
          <div className={map3 ? "map-container" : "hidden map-container"}>
            <iframe className="map"
        ...
        {kindergarten === SCHEDULE3.loc3.name && map3 &&
          <div className={map3 ? "map-container" : "hidden map-container"}>
            <iframe className="map"
        ...
        {kindergarten === SCHEDULE3.loc4.name && map3 &&
          <div className={map3 ? "map-container" : "hidden map-container"}>
            <iframe className="map"
