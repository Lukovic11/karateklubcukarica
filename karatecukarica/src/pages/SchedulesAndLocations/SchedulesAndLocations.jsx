  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Rasporedi i lokacije - Karate klub Čukarica"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://karatecukarica.rs/terminiilokacije"
        />
      </Helmet>
      <HerobannerV2
        image={locations}
        alt={LOCATIONS_IMG_ALT}
        title1={LOCATIONS_TITLE1}
      ...
      <div className="schedules-and-locations">
        ...
        <div className="location-wrapper">
          <Location3
            onSelectKg={(item) => setKindergarten(item)}
            onSetMap={(item) => setMap3(item)}
          />
